...
- [Reports](/analytics)`,
  ...
  "dashboard.rain": {
    title: "Suivi Rain tab",
    title_fr: "Onglet Suivi Rain",
    learnMoreHref: docHref("dashboard"),
    fr: `## Suivi Rain
Suivi quotidien de l'activité de la coordinatrice Rain sur ses 4 listes de missions.

## À quoi sert cet onglet
- Voir en un coup d'œil les patients **à l'humain**, **rappels**, **suivis** et **NHS manquants** qu'elle doit traiter.
- Suivre le taux de **complétion** de chaque liste et le nombre d'appels réellement passés.
- Cliquer sur un patient pour voir le **dernier appel** : audio, transcription et analyse critique générée par IA.
- Comparer l'activité sur **une journée ou une plage de dates**.

## Comment l'utiliser
1. Choisissez la **date ou la plage** en haut à droite (Aujourd'hui / Hier / plage personnalisée).
...
- Le badge "Appelé" ne compte que les appels passés par Rain elle-même (agent humain), jamais les agents IA.

## Liens utiles
- [Contacts](/contacts)
- [Suivi NHS S2](/dashboard)`,

    default: `## Suivi Rain tab
Daily tracking of coordinator Rain's activity across her 4 mission lists.

## What this tab is for
- See at a glance the patients needing **human follow-up**, **callbacks**, **check-ins**, and **missing NHS docs**.
- Track the **completion rate** of each list and how many calls were actually placed.
- Click a patient to see their **last call**: audio, transcript, and an AI-generated critical review.
- Compare activity over **a single day or a custom date range**.

## How to use it
1. Pick the **date or range** in the top right (Today / Yesterday / custom range).
...
- The "Called" badge only counts calls placed by Rain herself (human agent), never AI agents.
