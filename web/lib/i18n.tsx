...
const EN: Record<string, string> = {
  ...
  "des X leads": "of X leads",
  "Appels / lead jusqu'au décroché": "Calls / lead until answered",
  ...
  "faible confiance IA": "low AI confidence",
  "Qualifications — décrochés uniquement": "Qualifications — answered calls only",
  "% sur X décrochés": "% of X answered",
  "Transferts à traiter": "Pending transfers",
  "à passer à Rain / Summer": "to hand to Rain / Summer",
  "(dernières Xh)": "(last Xh)",
  "Voir tout →": "View all →",
  "Aucun transfert en attente sur les dernières Xh.": "No pending transfers in the last Xh.",
  "Humain": "Human",
  ...
  "Leads à transférer à un humain": "Leads to transfer to a human",
