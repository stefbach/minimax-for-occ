...
export const NHS_REPORT: Record<NhsReportKey, NhsReportCategory> = {
  approved: {
    ...
    patients: [
      ...
      { name: "Cheryl Marie Tomlinson", situation: "Opéré — phases 1 et 2 terminées." },
  ...
  missing_docs: {
    ...
    patients: [
      ...
      { name: "Ali Alburghol", sent_to_nhs: "17/01/2026", situation: "En attente du statut de visa du patient." },
