  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const qs = new URLSearchParams({
        ...
        ...(system && { system }),
        ...(global?.quals.length && { gf_qual: global.quals.join(",") }),
        ...(global?.agents.length && { gf_agent: global.agents.join(",") }),
        ...(global?.answered !== "all" && { gf_answered: global.answered }),
        ...(global?.attempt !== "all" && { gf_attempt: global.attempt }),
        ...(global?.durations.length && { gf_dur: global.durations.join(",") }),
        ...(global?.eligibility !== "all" && { gf_elig: global.eligibility }),
        ...(global?.sources.length && { gf_src: global.sources.join(",") }),
        ...(global?.q && { gf_q: global.q }),
        ...(orgId && { org_id: orgId }),
      });
