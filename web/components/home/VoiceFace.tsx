...
/**
 * VoiceFace — line-art illustration for the Métiers section: a woman's
 * profile whose voice leaves her lips as sound waves, then branches into
 * the six business verticals. Pure SVG, strokes bound to CSS variables so
 * it follows the violet palette and the day/night theme; the branch flow
 * reuses the global `axon-flow` keyframes.
 */
  ...
  return (
    <div className="mk-face-wrap">
      ...
      >
        ...
        {/* profile: forehead, nose, lips, chin, neck */}
        <path
