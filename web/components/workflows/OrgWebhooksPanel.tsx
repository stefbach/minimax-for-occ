      ...
      <div className="page-header" style={{ marginTop: 0 }}>
        <div>
          ...
          <div className="muted" style={{ fontSize: 13 }}>
            {t("Quand l'agent inscrit une qualification pendant l'appel, Axon appelle l'URL webhook de votre workflow n8n (ex : envoyer un email + WhatsApp après un RDV).")}
          </div>
        </div>
      ...
      {open && (
        <div className="card" style={{ marginBottom: 12 }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            ...
            <div>
              <label>{t("Valeurs déclenchantes (séparées par virgule, vide = toute valeur)")}</label>
              <input
                value={matchValues}
      ...
      {rows.length === 0 ? (
        <div className="card">
          <p className="muted" style={{ margin: 0 }}>
            {t("Aucun déclencheur. Ajoutez-en un pour relier une qualification (ex : RDV confirmé) à un workflow n8n.")}
          </p>
        </div>
      ) : (
